...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/anastasiosdadiotes/Library/Mobile Documents/com~apple~CloudDocs/Documents/PhD/Tasks/Hariri_Task/Hariri_Task_lastrun.py',
...
# Run 'Begin Experiment' code from number_of_trials
myCount = 0
...
for thisBlock in blocks:
    ...
    # Run 'Begin Routine' code from debugging_condition
    # print to know which condition is used
    print( f'condition is {condsFile}')
    textbox.reset()
    ...
    for thisTrial in trials:
        ...
        print(f'left stimuli is {stimuli_left}')
        print(f'right stimuli is {stimuli_right}')
        print(f'target is {target}')
        left_stimuli.setImage(stimuli_left)
        right_stimuli.setImage(stimuli_right)
        target_stim.setImage(target)
        # Run 'Begin Routine' code from number_of_trials
        # code component so each loop has only 6 trials. 'shapes.xlsx' 
        # condition file has 12 unique trials overall and we only want to display 
        # every loop.
        myCount = myCount + 1
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    # Run 'Begin Routine' code from debug_isi
    # printing for debugging
